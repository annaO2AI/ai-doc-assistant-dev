  ...
  return (
    <div className='full mt-6'>
      <div className="w-[88%] mx-auto flex flex-col transcription-welcommassege-main rounded-[20px] p-12 autopharmacySearch-min relative">
        {/* Header */}
        <div className="border-b-2 border-[#1b71a3] pb-4 mb-6">
          <h1 className="text-2xl font-bold text-[#fff]">Explanation of Benefits</h1>
          <p className="text-[#ffffffb3]">Claim ID: {eobData.id}</p>
