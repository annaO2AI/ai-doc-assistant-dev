...
export const PatientProfile: React.FC<PatientProfileProps> = ({ 
  ...
  return (
    <div
      className="flex gap-2 text-white items-center absolute left-8 top-8 z-20 cursor-pointer"
      onClick={onEditClick}
    >
      ...
      <span className="font-semibold text-white flex flex-col leading-[1.4]">
        ...
        <span className="text-white text-[14px] font-normal">Patient • MRN: {patient.mrn}</span>
      </span>
      <span>
