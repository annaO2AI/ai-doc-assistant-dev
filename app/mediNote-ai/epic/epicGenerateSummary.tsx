  ...
  return (
   ...
   {/* NEW: Info Cards Section */}
          <div className="flex  items-center gap-4 mb-8">
            ...
            {/* Symptoms Card */}
            <div className="bg-[#3C77EF] rounded-lg shadow-sm p-6 text-white w-[30%] h-[180px] relative">
              <div className="flex items-center mb-3">
            ...
            {/* Family History Card */}
            <div className="bg-[#62C6FF] rounded-lg shadow-sm p-6 text-white w-[30%] h-[180px] relative">
              <div className="flex items-center mb-3">
            ...
            {/* Next Steps Card */}
            <div className="bg-[#A76ED5] rounded-lg shadow-sm p-6 text-white w-[30%] h-[180px] relative">
              <div className="flex items-center mb-3">
