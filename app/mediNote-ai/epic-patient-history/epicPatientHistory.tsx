                  ...
                  <div className="overflow-x-auto">
                    <table className="min-w-full divide-y divide-gray-200 bg-white rounded-lg shadow">
                      ...
                      <tbody className="bg-white divide-y divide-gray-200">
                        {filteredPatients.map((patient) => {
                          const isSelected =
                            selectedPatient?.mrn === patient.mrn
                          return (
                            <tr
                              key={patient.id}
             ...
             onClick={(e) => e.stopPropagation()} >
              <div className="sticky top-0 bg-white border-b border-gray-200 p-6 flex items-center justify-between">
                <h3 className="text-xl font-semibold ot-title flex gap-3 items-center">
                  ...
                  <span>
                    Patient History - {selectedPatientForHistory?.full_name}{" "}
                    (MRN: {selectedPatientForHistory?.mrn})
                  </span>
                </h3>
                <button
                ...
                {documentReferencesLoading ? (
                  ...
                  <div className="space-y-6">
                    {documentReferences.map((document, index) => {
                      ...
                      const hasEncounters =
                        document.encounters && document.encounters.length > 0
                          ...
                          {isExpanded && (
                            <div className="mt-4 pt-4 border-t border-gray-200">
                              <div className="space-y-3">
                                <h5 className="font-semibold ot-title">
                                ...
                                <div className="mt-4 pt-4 border-t border-gray-200">
                                  <div className="grid grid-cols-2 gap-4 text-sm">
                                    <div>
                                      <span className="font-medium ot-title">
                                        Status:
                                      </span>
                                      <div className="mt-1">
                                        <span
                  ...
                  <div className="text-center py-12">
                    ...
                    <p className="text-gray-500 mt-4">
                      No patient history found for this patient
                    </p>
                  </div>
                ) : null}
              </div>
