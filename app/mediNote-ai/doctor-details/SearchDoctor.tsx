    ...
    return (
      ...
      <div className="flex justify-between">
        ...
        <div className="flex flex-wrap items-center gap-4 mb-6">
          <div className="relative flex-1 min-w-[500px] max-w-[600px]">
          ...
          <input
            type="text"
            className="w-32 px-3 py-3 border border-gray-300 rounded-lg bg-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 sm:text-sm"
        ...
        <div className="flex gap-2 justify-end mb-4">
          <button
            ...
            className={`px-4 py-2 mr-2 rounded-md h-[48px] ${viewMode === 'card' ? 'bg-blue-600 text-white' : 'text-gray-700'}`}
          >
          ...
          <button
            ...
            className={`px-4 py-2 rounded-md h-[48px] ${viewMode === 'table' ? 'bg-blue-600 text-white' : 'text-gray-700'}`}
          >
