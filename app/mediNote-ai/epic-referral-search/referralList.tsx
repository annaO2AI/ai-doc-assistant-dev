...
export default function ReferralList({ authToken }: ReferralListProps) {
  ...
  return (
    <div className="epic-patient-search mt-10">
      <div className="w-[88%] mx-auto flex flex-col transcription-welcommassege-main rounded-[20px] p-10 autopharmacySearch-min relative">
        ...
        <div className="mb-4">
          <h3 className="text-[24px] font-semibold text-[#fff] mb-3">
            Search Epic Patients - Service Requests
          </h3>
      ...
      {/* Modal Overlay */}
      {selectedPatient && (
        <div className="fixed inset-0 z-50 flex items-center justify-center glass-card" onClick={closeModal}>
          <div className="bg-white shadow-2xl w-[500px] h-[100vh] overflow-hidden flex flex-col absolute top-[0] right-[0]">
            {/* Modal Header */}
            <div className="sticky top-0 bg-white border-b border-gray-200 p-6 flex items-center justify-between">
              <h3 className="text-xl font-semibold ot-title flex gap-3 items-center">
                ...
                <span>
                  Service Requests - {selectedPatient.full_name} (MRN: {selectedPatient.mrn})
                </span>
              </h3>
              <button
                onClick={closeModal}
